...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,7\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,7\right)} \mathbf{H}^{\left(25,7\right)} \mathbf{H}^{\left(25,7\right)} \mathbf{H}^{\left(25,7\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,7\right)} \left(\mathbf{H}^{\left(25,7\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,7\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,9\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,9\right)} \mathbf{H}^{\left(25,9\right)} \mathbf{H}^{\left(25,9\right)} \mathbf{H}^{\left(25,9\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,9\right)} \left(\mathbf{H}^{\left(25,9\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,9\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,11\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,11\right)} \mathbf{H}^{\left(25,11\right)} \mathbf{H}^{\left(25,11\right)} \mathbf{H}^{\left(25,11\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,11\right)} \left(\mathbf{H}^{\left(25,11\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,11\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,13\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,13\right)} \mathbf{H}^{\left(25,13\right)} \mathbf{H}^{\left(25,13\right)} \mathbf{H}^{\left(25,13\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,13\right)} \left(\mathbf{H}^{\left(25,13\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,13\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,14\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,14\right)} \mathbf{H}^{\left(25,14\right)} \mathbf{H}^{\left(25,14\right)} \mathbf{H}^{\left(25,14\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,14\right)} \left(\mathbf{H}^{\left(25,14\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,14\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,16\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,16\right)} \mathbf{H}^{\left(25,16\right)} \mathbf{H}^{\left(25,16\right)} \mathbf{H}^{\left(25,16\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,16\right)} \left(\mathbf{H}^{\left(25,16\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,17\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,17\right)} \mathbf{H}^{\left(25,17\right)} \mathbf{H}^{\left(25,17\right)} \mathbf{H}^{\left(25,17\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,17\right)} \left(\mathbf{H}^{\left(25,17\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,17\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,18\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,18\right)} \mathbf{H}^{\left(25,18\right)} \mathbf{H}^{\left(25,18\right)} \mathbf{H}^{\left(25,18\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,18\right)} \left(\mathbf{H}^{\left(25,18\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,18\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,19\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,19\right)} \mathbf{H}^{\left(25,19\right)} \mathbf{H}^{\left(25,19\right)} \mathbf{H}^{\left(25,19\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,19\right)} \left(\mathbf{H}^{\left(25,19\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,19\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,21\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,21\right)} \mathbf{H}^{\left(25,21\right)} \mathbf{H}^{\left(25,21\right)} \mathbf{H}^{\left(25,21\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,21\right)} \left(\mathbf{H}^{\left(25,21\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,21\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,22\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,22\right)} \mathbf{H}^{\left(25,22\right)} \mathbf{H}^{\left(25,22\right)} \mathbf{H}^{\left(25,22\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,22\right)} \left(\mathbf{H}^{\left(25,22\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,22\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,23\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,23\right)} \mathbf{H}^{\left(25,23\right)} \mathbf{H}^{\left(25,23\right)} \mathbf{H}^{\left(25,23\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,23\right)} \left(\mathbf{H}^{\left(25,23\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,23\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,26\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,26\right)} \mathbf{H}^{\left(25,26\right)} \mathbf{H}^{\left(25,26\right)} \mathbf{H}^{\left(25,26\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,26\right)} \left(\mathbf{H}^{\left(25,26\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,26\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,27\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,27\right)} \mathbf{H}^{\left(25,27\right)} \mathbf{H}^{\left(25,27\right)} \mathbf{H}^{\left(25,27\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,27\right)} \left(\mathbf{H}^{\left(25,27\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,27\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,28\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,28\right)} \mathbf{H}^{\left(25,28\right)} \mathbf{H}^{\left(25,28\right)} \mathbf{H}^{\left(25,28\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,28\right)} \left(\mathbf{H}^{\left(25,28\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,28\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(25,29\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(25,29\right)} \mathbf{H}^{\left(25,29\right)} \mathbf{H}^{\left(25,29\right)} \mathbf{H}^{\left(25,29\right)} \cdots \right] = \left[ \mathbf{G}^{\left(25,29\right)} \left(\mathbf{H}^{\left(25,29\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(25,29\right)}\right| = 1
# \end{aligned}
# <codecell>
