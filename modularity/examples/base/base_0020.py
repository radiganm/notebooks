...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,3\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,3\right)} \mathbf{H}^{\left(20,3\right)} \mathbf{H}^{\left(20,3\right)} \mathbf{H}^{\left(20,3\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,3\right)} \left(\mathbf{H}^{\left(20,3\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,3\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,6\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,6\right)} \mathbf{H}^{\left(20,6\right)} \mathbf{H}^{\left(20,6\right)} \mathbf{H}^{\left(20,6\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,6\right)} \left(\mathbf{H}^{\left(20,6\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,6\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,7\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,7\right)} \mathbf{H}^{\left(20,7\right)} \mathbf{H}^{\left(20,7\right)} \mathbf{H}^{\left(20,7\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,7\right)} \left(\mathbf{H}^{\left(20,7\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,7\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# so we have
# \begin{aligned}
# \left|\mathbf{G}^{\left(20,8\right)}\right| = 0
# \end{aligned}
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,9\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,9\right)} \mathbf{H}^{\left(20,9\right)} \mathbf{H}^{\left(20,9\right)} \mathbf{H}^{\left(20,9\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,9\right)} \left(\mathbf{H}^{\left(20,9\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,9\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,11\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,11\right)} \mathbf{H}^{\left(20,11\right)} \mathbf{H}^{\left(20,11\right)} \mathbf{H}^{\left(20,11\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,11\right)} \left(\mathbf{H}^{\left(20,11\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,11\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,12\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,12\right)} \mathbf{H}^{\left(20,12\right)} \mathbf{H}^{\left(20,12\right)} \mathbf{H}^{\left(20,12\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,12\right)} \left(\mathbf{H}^{\left(20,12\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,12\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,13\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,13\right)} \mathbf{H}^{\left(20,13\right)} \mathbf{H}^{\left(20,13\right)} \mathbf{H}^{\left(20,13\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,13\right)} \left(\mathbf{H}^{\left(20,13\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,13\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,14\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,14\right)} \mathbf{H}^{\left(20,14\right)} \mathbf{H}^{\left(20,14\right)} \mathbf{H}^{\left(20,14\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,14\right)} \left(\mathbf{H}^{\left(20,14\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,14\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,15\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,15\right)} \mathbf{H}^{\left(20,15\right)} \mathbf{H}^{\left(20,15\right)} \mathbf{H}^{\left(20,15\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,15\right)} \left(\mathbf{H}^{\left(20,15\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,15\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# so we have
# \begin{aligned}
# \left|\mathbf{G}^{\left(20,16\right)}\right| = 0
# \end{aligned}
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,17\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,17\right)} \mathbf{H}^{\left(20,17\right)} \mathbf{H}^{\left(20,17\right)} \mathbf{H}^{\left(20,17\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,17\right)} \left(\mathbf{H}^{\left(20,17\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,17\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,18\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,18\right)} \mathbf{H}^{\left(20,18\right)} \mathbf{H}^{\left(20,18\right)} \mathbf{H}^{\left(20,18\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,18\right)} \left(\mathbf{H}^{\left(20,18\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,18\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,21\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,21\right)} \mathbf{H}^{\left(20,21\right)} \mathbf{H}^{\left(20,21\right)} \mathbf{H}^{\left(20,21\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,21\right)} \left(\mathbf{H}^{\left(20,21\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,21\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,22\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,22\right)} \mathbf{H}^{\left(20,22\right)} \mathbf{H}^{\left(20,22\right)} \mathbf{H}^{\left(20,22\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,22\right)} \left(\mathbf{H}^{\left(20,22\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,22\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,23\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,23\right)} \mathbf{H}^{\left(20,23\right)} \mathbf{H}^{\left(20,23\right)} \mathbf{H}^{\left(20,23\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,23\right)} \left(\mathbf{H}^{\left(20,23\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,23\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,24\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,24\right)} \mathbf{H}^{\left(20,24\right)} \mathbf{H}^{\left(20,24\right)} \mathbf{H}^{\left(20,24\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,24\right)} \left(\mathbf{H}^{\left(20,24\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \mathbf{H}^{\left(20,24\right)} = \{  \}
# \end{aligned}
# so we have
# \begin{aligned}
# \left|\mathbf{G}^{\left(20,24\right)}\right| = 0
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,24\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,26\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,26\right)} \mathbf{H}^{\left(20,26\right)} \mathbf{H}^{\left(20,26\right)} \mathbf{H}^{\left(20,26\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,26\right)} \left(\mathbf{H}^{\left(20,26\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,26\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,27\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,27\right)} \mathbf{H}^{\left(20,27\right)} \mathbf{H}^{\left(20,27\right)} \mathbf{H}^{\left(20,27\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,27\right)} \left(\mathbf{H}^{\left(20,27\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,27\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,28\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,28\right)} \mathbf{H}^{\left(20,28\right)} \mathbf{H}^{\left(20,28\right)} \mathbf{H}^{\left(20,28\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,28\right)} \left(\mathbf{H}^{\left(20,28\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,28\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,29\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,29\right)} \mathbf{H}^{\left(20,29\right)} \mathbf{H}^{\left(20,29\right)} \mathbf{H}^{\left(20,29\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,29\right)} \left(\mathbf{H}^{\left(20,29\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,29\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(20,30\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(20,30\right)} \mathbf{H}^{\left(20,30\right)} \mathbf{H}^{\left(20,30\right)} \mathbf{H}^{\left(20,30\right)} \cdots \right] = \left[ \mathbf{G}^{\left(20,30\right)} \left(\mathbf{H}^{\left(20,30\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(20,30\right)}\right| = 1
# \end{aligned}
# <codecell>
