...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,5\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,5\right)} \mathbf{H}^{\left(27,5\right)} \mathbf{H}^{\left(27,5\right)} \mathbf{H}^{\left(27,5\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,5\right)} \left(\mathbf{H}^{\left(27,5\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,5\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,7\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,7\right)} \mathbf{H}^{\left(27,7\right)} \mathbf{H}^{\left(27,7\right)} \mathbf{H}^{\left(27,7\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,7\right)} \left(\mathbf{H}^{\left(27,7\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,7\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,8\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,8\right)} \mathbf{H}^{\left(27,8\right)} \mathbf{H}^{\left(27,8\right)} \mathbf{H}^{\left(27,8\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,8\right)} \left(\mathbf{H}^{\left(27,8\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,10\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,10\right)} \mathbf{H}^{\left(27,10\right)} \mathbf{H}^{\left(27,10\right)} \mathbf{H}^{\left(27,10\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,10\right)} \left(\mathbf{H}^{\left(27,10\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,10\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,11\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,11\right)} \mathbf{H}^{\left(27,11\right)} \mathbf{H}^{\left(27,11\right)} \mathbf{H}^{\left(27,11\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,11\right)} \left(\mathbf{H}^{\left(27,11\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,11\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,12\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,12\right)} \mathbf{H}^{\left(27,12\right)} \mathbf{H}^{\left(27,12\right)} \mathbf{H}^{\left(27,12\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,12\right)} \left(\mathbf{H}^{\left(27,12\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,12\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,14\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,14\right)} \mathbf{H}^{\left(27,14\right)} \mathbf{H}^{\left(27,14\right)} \mathbf{H}^{\left(27,14\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,14\right)} \left(\mathbf{H}^{\left(27,14\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,14\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,15\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,15\right)} \mathbf{H}^{\left(27,15\right)} \mathbf{H}^{\left(27,15\right)} \mathbf{H}^{\left(27,15\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,15\right)} \left(\mathbf{H}^{\left(27,15\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,15\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,16\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,16\right)} \mathbf{H}^{\left(27,16\right)} \mathbf{H}^{\left(27,16\right)} \mathbf{H}^{\left(27,16\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,16\right)} \left(\mathbf{H}^{\left(27,16\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,17\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,17\right)} \mathbf{H}^{\left(27,17\right)} \mathbf{H}^{\left(27,17\right)} \mathbf{H}^{\left(27,17\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,17\right)} \left(\mathbf{H}^{\left(27,17\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,17\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,19\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,19\right)} \mathbf{H}^{\left(27,19\right)} \mathbf{H}^{\left(27,19\right)} \mathbf{H}^{\left(27,19\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,19\right)} \left(\mathbf{H}^{\left(27,19\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,19\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,20\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,20\right)} \mathbf{H}^{\left(27,20\right)} \mathbf{H}^{\left(27,20\right)} \mathbf{H}^{\left(27,20\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,20\right)} \left(\mathbf{H}^{\left(27,20\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,20\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,21\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,21\right)} \mathbf{H}^{\left(27,21\right)} \mathbf{H}^{\left(27,21\right)} \mathbf{H}^{\left(27,21\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,21\right)} \left(\mathbf{H}^{\left(27,21\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,21\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,22\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,22\right)} \mathbf{H}^{\left(27,22\right)} \mathbf{H}^{\left(27,22\right)} \mathbf{H}^{\left(27,22\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,22\right)} \left(\mathbf{H}^{\left(27,22\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,22\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,23\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,23\right)} \mathbf{H}^{\left(27,23\right)} \mathbf{H}^{\left(27,23\right)} \mathbf{H}^{\left(27,23\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,23\right)} \left(\mathbf{H}^{\left(27,23\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,23\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,24\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,24\right)} \mathbf{H}^{\left(27,24\right)} \mathbf{H}^{\left(27,24\right)} \mathbf{H}^{\left(27,24\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,24\right)} \left(\mathbf{H}^{\left(27,24\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,24\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,25\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,25\right)} \mathbf{H}^{\left(27,25\right)} \mathbf{H}^{\left(27,25\right)} \mathbf{H}^{\left(27,25\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,25\right)} \left(\mathbf{H}^{\left(27,25\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,25\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,28\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,28\right)} \mathbf{H}^{\left(27,28\right)} \mathbf{H}^{\left(27,28\right)} \mathbf{H}^{\left(27,28\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,28\right)} \left(\mathbf{H}^{\left(27,28\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,28\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,29\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,29\right)} \mathbf{H}^{\left(27,29\right)} \mathbf{H}^{\left(27,29\right)} \mathbf{H}^{\left(27,29\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,29\right)} \left(\mathbf{H}^{\left(27,29\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,29\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(27,30\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(27,30\right)} \mathbf{H}^{\left(27,30\right)} \mathbf{H}^{\left(27,30\right)} \mathbf{H}^{\left(27,30\right)} \cdots \right] = \left[ \mathbf{G}^{\left(27,30\right)} \left(\mathbf{H}^{\left(27,30\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(27,30\right)}\right| = 1
# \end{aligned}
# <codecell>
