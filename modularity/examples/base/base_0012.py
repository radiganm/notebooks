...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,5\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,5\right)} \mathbf{H}^{\left(12,5\right)} \mathbf{H}^{\left(12,5\right)} \mathbf{H}^{\left(12,5\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,5\right)} \left(\mathbf{H}^{\left(12,5\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,5\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,7\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,7\right)} \mathbf{H}^{\left(12,7\right)} \mathbf{H}^{\left(12,7\right)} \mathbf{H}^{\left(12,7\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,7\right)} \left(\mathbf{H}^{\left(12,7\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,7\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# so we have
# \begin{aligned}
# \left|\mathbf{G}^{\left(12,8\right)}\right| = 0
# \end{aligned}
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,10\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,10\right)} \mathbf{H}^{\left(12,10\right)} \mathbf{H}^{\left(12,10\right)} \mathbf{H}^{\left(12,10\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,10\right)} \left(\mathbf{H}^{\left(12,10\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,10\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,13\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,13\right)} \mathbf{H}^{\left(12,13\right)} \mathbf{H}^{\left(12,13\right)} \mathbf{H}^{\left(12,13\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,13\right)} \left(\mathbf{H}^{\left(12,13\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,13\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,14\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,14\right)} \mathbf{H}^{\left(12,14\right)} \mathbf{H}^{\left(12,14\right)} \mathbf{H}^{\left(12,14\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,14\right)} \left(\mathbf{H}^{\left(12,14\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,14\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,15\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,15\right)} \mathbf{H}^{\left(12,15\right)} \mathbf{H}^{\left(12,15\right)} \mathbf{H}^{\left(12,15\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,15\right)} \left(\mathbf{H}^{\left(12,15\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,15\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# so we have
# \begin{aligned}
# \left|\mathbf{G}^{\left(12,16\right)}\right| = 0
# \end{aligned}
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,17\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,17\right)} \mathbf{H}^{\left(12,17\right)} \mathbf{H}^{\left(12,17\right)} \mathbf{H}^{\left(12,17\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,17\right)} \left(\mathbf{H}^{\left(12,17\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,17\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,19\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,19\right)} \mathbf{H}^{\left(12,19\right)} \mathbf{H}^{\left(12,19\right)} \mathbf{H}^{\left(12,19\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,19\right)} \left(\mathbf{H}^{\left(12,19\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,19\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,20\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,20\right)} \mathbf{H}^{\left(12,20\right)} \mathbf{H}^{\left(12,20\right)} \mathbf{H}^{\left(12,20\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,20\right)} \left(\mathbf{H}^{\left(12,20\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,20\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,21\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,21\right)} \mathbf{H}^{\left(12,21\right)} \mathbf{H}^{\left(12,21\right)} \mathbf{H}^{\left(12,21\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,21\right)} \left(\mathbf{H}^{\left(12,21\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,21\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,23\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,23\right)} \mathbf{H}^{\left(12,23\right)} \mathbf{H}^{\left(12,23\right)} \mathbf{H}^{\left(12,23\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,23\right)} \left(\mathbf{H}^{\left(12,23\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,23\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# so we have
# \begin{aligned}
# \left|\mathbf{G}^{\left(12,24\right)}\right| = 0
# \end{aligned}
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,25\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,25\right)} \mathbf{H}^{\left(12,25\right)} \mathbf{H}^{\left(12,25\right)} \mathbf{H}^{\left(12,25\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,25\right)} \left(\mathbf{H}^{\left(12,25\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,25\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,26\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,26\right)} \mathbf{H}^{\left(12,26\right)} \mathbf{H}^{\left(12,26\right)} \mathbf{H}^{\left(12,26\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,26\right)} \left(\mathbf{H}^{\left(12,26\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,26\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,27\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,27\right)} \mathbf{H}^{\left(12,27\right)} \mathbf{H}^{\left(12,27\right)} \mathbf{H}^{\left(12,27\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,27\right)} \left(\mathbf{H}^{\left(12,27\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,28\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,28\right)} \mathbf{H}^{\left(12,28\right)} \mathbf{H}^{\left(12,28\right)} \mathbf{H}^{\left(12,28\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,28\right)} \left(\mathbf{H}^{\left(12,28\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,28\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,29\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,29\right)} \mathbf{H}^{\left(12,29\right)} \mathbf{H}^{\left(12,29\right)} \mathbf{H}^{\left(12,29\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,29\right)} \left(\mathbf{H}^{\left(12,29\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,29\right)}\right| = 1
# \end{aligned}
# <codecell>
...
# yeilding
# \begin{aligned}
# \mathbf{X}^{\left(12,30\right)} = \{ ,  \cdots \} = \left[ \mathbf{G}^{\left(12,30\right)} \mathbf{H}^{\left(12,30\right)} \mathbf{H}^{\left(12,30\right)} \mathbf{H}^{\left(12,30\right)} \cdots \right] = \left[ \mathbf{G}^{\left(12,30\right)} \left(\mathbf{H}^{\left(12,30\right)}\right)^{*} \right]
# \end{aligned}
# where
# \begin{aligned}
...
# \end{aligned}
# \begin{aligned}
# \left|\mathbf{H}^{\left(12,30\right)}\right| = 1
# \end{aligned}
# <codecell>
