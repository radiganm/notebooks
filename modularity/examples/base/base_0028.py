...
# <headingcell level=4>
# Example #1: $\mathbf{X}^\left({b=28,m=2}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #2: $\mathbf{X}^\left({b=28,m=3}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #3: $\mathbf{X}^\left({b=28,m=4}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #4: $\mathbf{X}^\left({b=28,m=5}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #5: $\mathbf{X}^\left({b=28,m=6}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #6: $\mathbf{X}^\left({b=28,m=7}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #7: $\mathbf{X}^\left({b=28,m=8}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #8: $\mathbf{X}^\left({b=28,m=9}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #9: $\mathbf{X}^\left({b=28,m=10}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #10: $\mathbf{X}^\left({b=28,m=11}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #11: $\mathbf{X}^\left({b=28,m=12}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #12: $\mathbf{X}^\left({b=28,m=13}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #13: $\mathbf{X}^\left({b=28,m=14}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #14: $\mathbf{X}^\left({b=28,m=15}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #15: $\mathbf{X}^\left({b=28,m=16}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #16: $\mathbf{X}^\left({b=28,m=17}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #17: $\mathbf{X}^\left({b=28,m=18}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #18: $\mathbf{X}^\left({b=28,m=19}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #19: $\mathbf{X}^\left({b=28,m=20}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #20: $\mathbf{X}^\left({b=28,m=21}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #21: $\mathbf{X}^\left({b=28,m=22}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #22: $\mathbf{X}^\left({b=28,m=23}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #23: $\mathbf{X}^\left({b=28,m=24}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #24: $\mathbf{X}^\left({b=28,m=25}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #25: $\mathbf{X}^\left({b=28,m=26}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #26: $\mathbf{X}^\left({b=28,m=27}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #28: $\mathbf{X}^\left({b=28,m=29}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
...
# <headingcell level=4>
# Example #29: $\mathbf{X}^\left({b=28,m=30}\right)$
# <markdowncell>
# \begin{aligned}
# \mathbf{X}_n = 28^n \mod m
# \end{aligned}
