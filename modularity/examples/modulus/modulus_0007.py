...
# <headingcell level=4>
# Example #1: $\mathbf{X}^\left({b=2,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #2: $\mathbf{X}^\left({b=3,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #3: $\mathbf{X}^\left({b=4,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #4: $\mathbf{X}^\left({b=5,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #5: $\mathbf{X}^\left({b=6,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #7: $\mathbf{X}^\left({b=8,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #8: $\mathbf{X}^\left({b=9,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #9: $\mathbf{X}^\left({b=10,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #10: $\mathbf{X}^\left({b=11,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #11: $\mathbf{X}^\left({b=12,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #12: $\mathbf{X}^\left({b=13,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #13: $\mathbf{X}^\left({b=14,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #14: $\mathbf{X}^\left({b=15,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #15: $\mathbf{X}^\left({b=16,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #16: $\mathbf{X}^\left({b=17,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #17: $\mathbf{X}^\left({b=18,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #18: $\mathbf{X}^\left({b=19,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #19: $\mathbf{X}^\left({b=20,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #20: $\mathbf{X}^\left({b=21,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #21: $\mathbf{X}^\left({b=22,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #22: $\mathbf{X}^\left({b=23,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #23: $\mathbf{X}^\left({b=24,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #24: $\mathbf{X}^\left({b=25,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #25: $\mathbf{X}^\left({b=26,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #26: $\mathbf{X}^\left({b=27,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #27: $\mathbf{X}^\left({b=28,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #28: $\mathbf{X}^\left({b=29,m=7}\right)$
# <markdowncell>
# \begin{aligned}
...
# <headingcell level=4>
# Example #29: $\mathbf{X}^\left({b=30,m=7}\right)$
# <markdowncell>
# \begin{aligned}
